        ...
        <div className="min-h-[70vh] flex items-center justify-center px-4">
            <div className="card w-full max-w-md bg-base-100 shadow-xl border">
                <div className="card-body text-center space-y-4">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-success">Payment Successful</h2>
                    <p className="text-sm md:text-base text-gray-500">Thank you! Your payment has been processed successfully.</p>

                    {paymentInfo?.transactionId && (
                        <div className="bg-base-200 rounded-lg p-3 text-sm break-all">
                            <span className="font-semibold">Transaction ID:</span>
                            <p className="mt-1 text-primary">{paymentInfo.transactionId}</p>
                        </div>
                    )}
                </div>
            </div>
